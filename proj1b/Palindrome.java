...
public class Palindrome {
    ...
    private boolean isPalindromeHelper(Deque<Character> characterDeque) {
    ...
    private boolean isPalindromeHelper(Deque<Character> characterDeque, CharacterComparator cc) {
